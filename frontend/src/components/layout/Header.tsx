...
const NAV_LINKS = [
  ...
  { to: "/my-songs", label: "My Songs", icon: "M9 18V5l12-2v13M9 18c0 1.105-1.343 2-3 2s-3-.895-3-2 1.343-2 3-2 3 .895 3 2zm12-3c0 1.105-1.343 2-3 2s-3-.895-3-2 1.343-2 3-2 3 .895 3 2z" },
  { to: "/merged-videos", label: "Merged", icon: "M22 11.08V12a10 10 0 1 1-5.93-9.14" },
  { to: "/my-playlists", label: "Playlists", icon: "M9 19V6l12-3v13M9 19c0 1.105-1.343 2-3 2s-3-.895-3-2 1.343-2 3-2 3 .895 3 2zm12-3c0 1.105-1.343 2-3 2s-3-.895-3-2 1.343-2 3-2 3 .895 3 2zM9 10l12-3" },
];
